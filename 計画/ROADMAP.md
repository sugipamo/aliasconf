...
- [x] 環境変数サポート実装計画書作成 ✅ 2025/07/04（計画/202507040158_計画_環境変数サポート実装.md）
- [x] コントリビューションガイドラインの作成 ✅ 2025/07/04（CONTRIBUTING.md、CODE_OF_CONDUCT.md、Issue/PRテンプレート作成済み）
